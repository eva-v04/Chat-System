...
Το **UDP Chat System** αποτελεί την ολοκληρωμένη υλοποίηση της ομαδικής εργασίας για το μάθημα **Δίκτυα Υπολογιστών (Εαρινό Εξάμηνο 2026)**.
...
- Thread-safe διαχείριση κοινόχρηστων δεδομένων
- Automatic cleanup ανενεργών clients
- Αποτροπή πρόσβασης σε ιδιωτικά μηνύματα τρίτων χρηστών
...
- βελτίωση της τεκμηρίωσης του έργου
- μορφοποίηση και οργάνωση των αποτελεσμάτων δοκιμών
